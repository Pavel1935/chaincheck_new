...
@pytest.mark.parametrize(
        ...
        [
            ...
            ("bsc", "0x304a554a310C7e546dfe434669C62820b7D83490"),  # 20-39
...
def test_risk_score_wallet_bsc(network, wallet, tokens):
...
def test_risk_score_wallet_ether(network, wallet, tokens):
            access_token = tokens["access_token"]
...
def test_risk_score_wallet_tron(network, wallet, tokens):
            access_token = tokens["access_token"]
            headers = {'Authorization': f'Bearer ' + access_token}
